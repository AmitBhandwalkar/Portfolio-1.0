    ...
    <div className="contact" ref={ref} onSubmit={sendEmail}>
      ...
      <motion.div className="phoneSvg"
        ...
        >
          ...
          <div className="contact__title">Get in <span>Touch</span></div>
          <a href="mailto:amitbhandwalkar66@gmail.com"><i className="fa-solid fa-envelope"></i> amitbhandwalkar66@gmail.com </a>
           <p>Have a project, idea, or just want to say hi? Let’s chat!</p> 
